...
import { Printer, FileText, CheckCircle, X, Factory, QrCode } from "lucide-react"
  ...
  return (
    <div className="min-h-screen p-6 pb-32 relative">
      ...
      <div className="mb-6 text-center">
        <h1 className="text-2xl font-bold">{massProductionMode ? "Mass Production Print" : "Print Activation"}</h1>
      </div>
        ...
        <CardContent>
          {!isPrinting && !printComplete && !massProductionMode && (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-6">Ready to print your card activation receipt</p>
              <Button
          ...
          {isPrinting && (
            <div className="py-4">
              <div className="flex items-center justify-center mb-6">
                ...
                <span className="ml-3 text-primary font-medium">Printing...</span>
              </div>
          ...
          {printComplete && (
            <div className="text-center py-8">
              ...
              <p className="text-primary font-semibold text-lg mb-2">Print Complete!</p>
