            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground mb-3">
                  This action will <strong>permanently remove</strong> your card
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <p>
                    • You will need to request a new card to continue using our
                    services
                  </p>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              This will permanently delete your card and remove all associated
    ...
    <div className="min-h-screen p-6 pb-24 relative">
      ...
      <div className="mb-6 flex items-center justify-center">
        <h1 className="text-2xl font-bold">
          {isComplete ? "Reset Complete" : "Processing Reset..."}
        </h1>
      </div>
